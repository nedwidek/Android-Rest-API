 ...
 */
public class DeleteTask extends AsyncTask<String, String, HttpReturn>{
     ...
     * 
     */
    public DeleteTask(String restUrl, RestCallback callback, HashMap<String, String> headers, String username, String password){
    ...
    protected HttpReturn doInBackground(String... params) {
    	try {
    		...
    		return request.doDeleteRequest();
    	} catch (Throwable t) {
