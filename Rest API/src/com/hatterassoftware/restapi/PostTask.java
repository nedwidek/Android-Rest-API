 ...
 */
public class PostTask extends AsyncTask<String, String, HttpReturn>{
     ...
     * 
     */
    public PostTask(String restUrl, String requestBody, RestCallback callback, HashMap<String, String> headers, String username, String password){
    ...
    protected HttpReturn doInBackground(String... params) {
    	try {
    		...
    		return request.doPostRequest(requestBody);
    	} catch (Throwable t) {
